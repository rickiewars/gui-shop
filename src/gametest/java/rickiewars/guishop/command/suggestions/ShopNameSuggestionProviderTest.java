...
public class ShopNameSuggestionProviderTest extends SuggestionsCommandTest {
    ...
    public void suggestsShopNamesMatchingThePrefixCaseInsensitively(GameTestHelper context) {
        ...
        context.assertTrue(suggestions.contains("Cool Shop"), "expected the matching shop to be suggested");
        context.assertTrue(!suggestions.contains("Other Shop"), "the non-matching shop must not be suggested");
        context.succeed();
    }
